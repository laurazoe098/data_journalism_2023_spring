...
**Answer** 
Now we have the 2023 press releases and the titles and it is also now an actual data frame not just a list. 
```{r}
...
**Answer** 
We might want to add information about key words in the press releases or the topic that they are about.
...
**Answer** 
The output suggests that there are 122 <ul> tags in the HTML source. It is also included other <li> tags that we don't need so we need to narrow it down.
```{r}
...
**Answer** 
This isolates the text inside the tag, which makes it easier to read than the HTML output. 
...
**Answer** 
Now we created a dataframe of the text of the title of the releases from above. There is only one column called value. 
```{r}
