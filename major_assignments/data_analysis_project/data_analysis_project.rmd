...
```
```{r}
#Question 1: How does the amount of energy within music compare to the number of views the song has?
...
#Note: The problem here is that some songs have only 2 views and some have thousands of views, is there a better way to compare here? 
...
#Note: The most common keys are 1,7 and 2. 1 is the C# key, 7 is G, and 2 is D. These key's occur 5, 3 and 2 times respectively. Since C# occurs five times within the top 20 songs in the data, our major finding is that the C# key is occurring about 25% of the time among the top 20 most streamed songs.
