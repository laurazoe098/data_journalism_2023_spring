...
https://www.datawrapper.de/_/OIUhA/
...
Before, the whole US map was shown with only Maryland counties highlighted. It was very hard to see the counties since it was so zoomed out. Now it only shows the state of Maryland and it's counties. 
...
**Answer** Describe the changes from the previous map
Now, the map has more infromation for the reader in the headline and description. Also, if you hover over each county you see the county name and the specific percentage of votes that Wes Moore got.
...
https://www.datawrapper.de/_/302pg/
