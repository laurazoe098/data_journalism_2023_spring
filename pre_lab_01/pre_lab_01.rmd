...
**Answer**
The code is counting the classes by group, or by term.
...
**Answer**
The second column is now counting the term that had the most classes.
...
There is now a column for mean number of seats and median number of seats for each row.
**Answer**
...
**Answer**
Now, the data is sorted by department in the first row, and all the additional data calculation (sum, median, mean) are in columns next to that row.
### Task 12: Questions
...
1.  What college department offers classes with the lowest student to teacher ratio?

2.  What class has the most seats offered in the whole university?

3.  What college department offers classes with the highest student to teacher ratio?
