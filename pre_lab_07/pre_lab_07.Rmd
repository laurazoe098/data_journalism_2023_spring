...
**Answer** 
Howard County holds the highest household income in Maryland according to census.
```{r}
md %>%
...
The difference between Calvert and Montgomery is within the margin of errors and over lap by a lot.The differences aren't that significant.

Is the difference between Howard and everyone else significant? **Answer**
Yes, the difference between Howard and every other county it is significant. There is not overlap with any margin of errors so it is clear that Howard has the highest average household income. 
...
**Answer**
The jurisdiction that saw the largest increase in median income was Baltimore City. No counties saw their median income fall from 2010-2021.
```{r}
md10 %>%
...
**Answer**
We could find if a higher or lower household income influences how many student's are enrolled in a high school by zip code. Our answer might be hard to interpret because sometimes the household zip code is not the same as a student's high school zip code, which could cause some inaccurate findings. 
```{r}
...
**Answer**
The average household income for high schools that have 60% or more graduates was $111,448.3 while the average household income for high schools that have less than 40% of graduates was $69,252.24. It seems like there are more graduates the higher the average household income is. 
```{r}
...
**Answer** 
Another question you could ask is whether there is a significant difference in high school graduates by county depending if they live with one parent or if they live with both parents in their household.